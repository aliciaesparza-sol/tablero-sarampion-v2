...
docx_path = r"C:\Users\aicil\OneDrive\Escritorio\PVU\SARAMPIÓN\CONASABI\EVIDENCIAS CONASABI_27FEBRERO2026\Resumen_Vacunacion_Simplificado_V3.docx"
pdf_path = r"C:\Users\aicil\OneDrive\Escritorio\PVU\SARAMPIÓN\CONASABI\EVIDENCIAS CONASABI_27FEBRERO2026\Resumen_Vacunacion_Simplificado_V3.pdf"

# Generate DOCX
try:
    doc = Document()
    doc.add_heading('Resumen de Vacunación Nacional y Estatal', 0)
    
    # Destacar el total global de Durango
    p_total = doc.add_paragraph()
    p_total.alignment = WD_PARAGRAPH_ALIGNMENT.CENTER
    run_total1 = p_total.add_run('TOTAL GLOBAL DE DOSIS APLICADAS EN DURANGO (2026)\n')
    run_total1.bold = True
    run_total1.font.size = Pt(16)
    run_total1.font.color.rgb = RGBColor(0, 112, 192) # Azul oscuro
    
    run_total2 = p_total.add_run('44,344 dosis\n')
    run_total2.bold = True
    run_total2.font.size = Pt(24)
    run_total2.font.color.rgb = RGBColor(0, 112, 192)
    
    run_total3 = p_total.add_run('Corte: 27 de febrero de 2026')
    run_total3.italic = True
    run_total3.font.size = Pt(12)

    doc.add_heading('Dosis Aplicadas por Grupos Prioritarios y Rubros Clave', level=1)
    ...
    data = [
        ...
        ('TOTAL GLOBAL DURANGO (Acumulado 2026)', '41,535', '44,344', '+2,809', '+6.8%')
    ]
