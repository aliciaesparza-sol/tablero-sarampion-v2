...
try:
    ...
    print("--- CARBON ---")
    print(mez[mez['NOM_LOC'].str.contains('CARBON', case=False, na=False)][['NOM_LOC', 'POBTOT']])
    
    print("\n--- MANUEL ---")
    print(mez[mez['NOM_LOC'].str.contains('MANUEL', case=False, na=False)][['NOM_LOC', 'POBTOT']])
