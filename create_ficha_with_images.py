...
img1_path = r"C:\Users\aicil\.gemini\antigravity\scratch\ficha_extracted\word\media\image1.jpeg"
img2_path = r"C:\Users\aicil\.gemini\antigravity\scratch\ficha_extracted\word\media\image2.jpg"
...
try:
    ...
    if os.path.exists(img1_path):
        ...
        p_img.add_run().add_picture(img1_path, width=Inches(3.5))
    if os.path.exists(img2_path):
        p_img = doc.add_paragraph()
        p_img.alignment = WD_ALIGN_PARAGRAPH.CENTER
        p_img.add_run().add_picture(img2_path, width=Inches(3.5))
    doc.add_paragraph()
    ...
    print("Document successfully updated and saved with images.")
