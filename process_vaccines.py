...
markdown = "# Resumen de Dosis Aplicadas Vacuna COVID-19\n\n"
markdown += "### Dosis Aplicadas\n\n"
...
with open(r'C:\Users\aicil\.gemini\antigravity\scratch\covid_summary.md', 'w', encoding='utf-8') as f:
    f.write(markdown)
